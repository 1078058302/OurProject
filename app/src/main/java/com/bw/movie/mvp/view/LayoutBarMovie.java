...
public class LayoutBarMovie extends RelativeLayout{
    ...
    public LayoutBarMovie(Context context) {
        super(context);
        init(context);
    }

    public LayoutBarMovie(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LayoutBarMovie(Context context, AttributeSet attrs, int defStyleAttr) {
